...
namespace StringCalculator.Tests
{
    ...
    class StringValidatorTests
    {
        ...
        public void Validate_GivenANegativeNumber_ShouldReturnNegativesNotAllowed(string expected, string numbers)
        {
            //---------------Arrange-------------------
        ...
        public void Validate_GivenNegativeNumbers_ShouldReturnNegativesNotAllowed(string expected, string numbers)
        {
            //---------------Arrange-------------------
            var sut = CreateStringValidator();
            //---------------Act ----------------------
